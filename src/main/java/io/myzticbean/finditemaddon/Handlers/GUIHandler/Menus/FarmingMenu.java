...
public class FarmingMenu extends CategoryPaginated {

    ArrayList<ItemStack> itemStacks = new ArrayList<>();

    public FarmingMenu(PlayerMenuUtility playerMenuUtility) {
        super(playerMenuUtility);
        addMenuPotions();
    }

    public void addMenuPotions() {
        itemStacks.add(new ItemStack(Material.BLAZE_ROD));
        itemStacks.add(new ItemStack(Material.BLAZE_POWDER));
        itemStacks.add(new ItemStack(Material.BONE));
        itemStacks.add(new ItemStack(Material.BREAD));
        itemStacks.add(new ItemStack(Material.CACTUS));
        itemStacks.add(new ItemStack(Material.CARROT));
        itemStacks.add(new ItemStack(Material.COOKED_BEEF));
        itemStacks.add(new ItemStack(Material.COOKIE));
        itemStacks.add(new ItemStack(Material.EGG));
        itemStacks.add(new ItemStack(Material.ENDER_PEARL));
        itemStacks.add(new ItemStack(Material.GUNPOWDER));
        itemStacks.add(new ItemStack(Material.HONEYCOMB));
        itemStacks.add(new ItemStack(Material.LEATHER));
        itemStacks.add(new ItemStack(Material.POTATO));
        itemStacks.add(new ItemStack(Material.QUARTZ));
        itemStacks.add(new ItemStack(Material.RABBIT_FOOT));
        itemStacks.add(new ItemStack(Material.STRING));
        itemStacks.add(new ItemStack(Material.SUGAR_CANE));
    }

    @Override
    public String getMenuName() {
        return Utils.chat("&8Farming & Mob Drops");
    }
            ...
            if (player.hasPermission(PlayerPerms.FINDITEM_USE.value())) {
                ...
                if (FindItemAddOn.getQsApiInstance().isQSShopCacheImplemented()) {
                    Bukkit.getScheduler().runTaskAsynchronously(FindItemAddOn.getInstance(), () -> {
                         ...
                         */
                        FoundShopsMenu menu = new FoundShopsMenu(FindItemAddOn.getPlayerMenuUtility(player), searchResultList, ShopCategory.FARMING, mat, isBuying, SearchType.NORMAL);
                        Bukkit.getScheduler().runTask(FindItemAddOn.getInstance(), () -> menu.open(searchResultList));
                    });
                }
